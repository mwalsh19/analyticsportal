...
<section class = "content-header clearfix">
    <h1>
        <span>Manager > </span><span class="blue-span"><a href="<?php echo Url::to(['company/index']); ?>">Roles Overview</a> > </span><span>Add Role</span>
    </h1>
    <?php
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                <div class="max-width-300">
                                    <?= $form->field($model, 'role_description')->textarea() ?>
                                </div>
                            </div>
