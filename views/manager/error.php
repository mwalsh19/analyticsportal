...
<style>
    *, *:after, *:before {
    ...
    .error-page {
        ...
        text-align: center;
        background: #378dbc;
        background: -moz-linear-gradient(top, #378dbc 0%, #328ebc 100%);
        background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #378dbc), color-stop(100%, #328ebc));
        background: -webkit-linear-gradient(top, #378dbc 0%, #328ebc 100%);
        background: -o-linear-gradient(top, #378dbc 0%, #328ebc 100%);
        background: -ms-linear-gradient(top, #378dbc 0%, #328ebc 100%);
        background: linear-gradient(to bottom, #378dbc 0%, #328ebc 100%);
        filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='$firstColor', endColorstr='$secondColor',GradientType=0 ); }
    .error-page:before {
        width: 63px;
        height: 63px;
        border-radius: 50%;
        box-shadow: 3px 25px 0 5px #328ebc;
        content: '';
        z-index: -1;
        display: block;
        position: relative;
    ...
    <div class="error-page-wrap">
        <article class="error-page gradient">
            <hgroup>
                ...
                <h2><?= app\components\Utils::httpErrors($exception->statusCode); ?></h2>
            </hgroup>
            <br>
        </article>
    </div>
